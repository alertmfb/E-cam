...
export function PictoralEvidenceForm() {
  const form = useForm<z.infer<typeof peS>>({
    resolver: zodResolver(peS),
    defaultValues: {
      // date: '',
    },
  })
  function onSubmit(values: z.infer<typeof peS>) {
    console.log(values)
  }
  return (
    <Form {...form}>
        ...
        <div className="flex flex-col items-center justify-start gap-10 border p-4 rounded-lg">
          <FormSection>
            <SectionInputContainer>
              <FormItem>
                <FormLabel>Collateral Pictures</FormLabel>
                <FormControl>
                  <Input type="file" />
                </FormControl>
                <FormMessage />
          ...
          <FormSection>
            <SectionInputContainer>
              <FormItem>
                <FormLabel>
                  Customers Business Place (Loan Officer and Customer)
                </FormLabel>
                <FormControl>
                  <Input type="file" />
                </FormControl>
